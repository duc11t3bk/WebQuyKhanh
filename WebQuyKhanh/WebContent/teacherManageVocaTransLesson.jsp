				...
				<div id="new-level" class="col-lg-offset-3 col-lg-6">
					<div class="panel panel-default">
						<div class="panel-body" style="padding-top:0px">
							...
							<div class="row">
								<h5 class="col-lg-3" style="display:inline">Tên bài mới</h5>
							...
							<div class="panel-heading">
								<div class="panel-title">
									<ol class="breadcrumb">
									  	...
									  	<li class="active">Bài 1 - Bài 25</li>					
									</ol>
								</div>
							</div>
							<div class="panel-body">
								<div class="row">
									<button id="createNew" class="btn btn-default" style="padding:20px; margin-left:30px"><span class="glyphicon glyphicon-new-window"></span> Tạo bài mới </button>
								</div>
								<div class="row" style="margin-top:20px">
									<div class="col-lg-12">
										<div class="col-lg-4 myItem">
											<h5>Bài 1</h5>
										</div>
										<div class="col-lg-4 myItem">
											<h5>Bài 1</h5>
