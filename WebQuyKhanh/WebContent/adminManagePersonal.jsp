						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											<input class="col-lg-offset-3 col-lg-5" type="text" placeholder="Mật khẩu hiện tại" />
										</div>
										<div class="row">
											<input class="col-lg-offset-3 col-lg-5" type="text" placeholder="Mật khẩu mới" />
										</div>
										<div class="row">
											<input class="col-lg-offset-3 col-lg-5" type="text" placeholder="Nhập lại mật khẩu mới" />
										</div>
										<div class="row">
											<input class="col-lg-offset-4 col-lg-3 btn btn-info" type="button" value="Đổi mật khẩu" />
										</div>
									</div>
								</div>
							</div>
