					...
					<div class="col-lg-10 main-content">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<div class="row">
									<a href="adminAddNewMember.html"> <button class="btn btn-default" style="padding:20px; margin-left:30px"><span class="glyphicon glyphicon-new-window"></span> Thêm thành viên mới </button></a>
								</div>
