					...
					<div class="col-lg-10 main-content">
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title">Quản lí tài liệu tham khảo</div>
							</div>
							<div class="panel-body">
								<div class="row">
									<a href="adminAddNewTeacher.html"> <button class="btn btn-default" style="padding:20px; margin-left:30px"><span class="glyphicon glyphicon-new-window"></span> Thêm tài liệu mới </button>
									</a>
								</div>
