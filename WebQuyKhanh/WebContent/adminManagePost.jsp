					...
					<div class="col-lg-10 main-content">
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<div class="row">
									<a href="teacherCreateNewPost.html"><button class="btn btn-default" style="padding:20px; margin-left:30px"><span class="glyphicon glyphicon-new-window"></span> Thêm bài viết mới  </button></a>
								</div>
